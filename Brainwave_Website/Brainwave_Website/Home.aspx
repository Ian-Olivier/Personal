						...
						<div class="row topmargin-sm clearfix">
                            ...
                            <div class="col-md-4 bottommargin-sm">
								<div class="feature-box media-box fbox-bg">
									...
									<div class="fbox-desc">
										<h3 class="nott ls0 t600">Primary school<span class="subtitle font-secondary t300 ls0">English and Maths learners, as well as teacher empowerment.</span></h3>
                            ...
                            <div class="col-md-4 bottommargin-sm">
								<div class="feature-box media-box fbox-bg">
									...
									<div class="fbox-desc">
										...
										<a href="Onlinecareer.aspx" class="button-link noborder color">Read More</a>
									</div>
								</div>
							</div>
                         ...
                         <div class="row topmargin-sm clearfix">
                              ...
                              <div class="col-md-4 bottommargin-sm">
								<div class="feature-box media-box fbox-bg">
									...
									<div class="fbox-desc">
										<h3 class="nott ls0 t600">Motivational Workshops<span class="subtitle font-secondary t300 ls0">Life Skills and Anger Management.</span></h3>
							...
							<div class="col-md-4 bottommargin-sm">
								<div class="feature-box media-box fbox-bg">
									...
									<div class="fbox-desc">
										<h3 class="nott ls0 t600">Success Stories<span class="subtitle font-secondary t300 ls0">Testimonials from our learners.</span></h3>
