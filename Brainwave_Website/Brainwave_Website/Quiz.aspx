<%@ Page Title="" Language="C#" MasterPageFile="~/Navigation.Master" AutoEventWireup="true" CodeBehind="Quiz.aspx.cs" Inherits="Brainwave_Website.Quiz" %>
						...
						<div class="swiper-slide dark" style="background-image: url('images/Brainwave/tes.jpeg');">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center">
									...
									<p style="color:#009999" data-caption-animate="fadeInUp" data-caption-delay="200">We've gone out for tea, fun quizes will be up as soon as it becomes available</p>
