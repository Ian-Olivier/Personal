<%@ Page Title="" Language="C#" MasterPageFile="~/Navigation.Master" AutoEventWireup="true" CodeBehind="Area9.aspx.cs" Inherits="Brainwave_Website.Area9" %>
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					...
					<li class="active">CAREER AREA: 9</li>
				</ol>
			</div>
					...
					<div class="single-post nobottommargin">
						...
						<div class="entry clearfix">
							...
							<div class="entry-title">
								<h1>LANGUAGES AND LAW</h1>
							</div><!-- .entry-title end -->							

							<!-- Entry Image
							============================================= -->
							<div class="entry-image bottommargin">
								<a href="#"><img src="images/Brainwave/Law 2.png" alt="Blog Single"></a>
							</div><!-- .entry-image end -->
							...
							<div class="col_half nobottommargin">
								...
								<div class="mpost clearfix">
									<div class="entry-image">
										<a href="Area7.aspx"><img src="images/Brainwave/Hospitality.jpg" alt="Blog Single"></a>
									</div>
									<div class="entry-c">
										<div class="entry-title">
											<h4><a href="Area7.aspx">SERVICES</a></h4>
										</div>
								...
								<div class="mpost clearfix">
									<div class="entry-image">
										<a href="Area6.aspx"><img src="images/Brainwave/edus.jpg" alt="Blog Single"></a>
									</div>
									<div class="entry-c">
										<div class="entry-title">
											<h4><a href="Area6.aspx">HUMAN, SOCIAL AND EDUCATION</a></h4>
										</div>
