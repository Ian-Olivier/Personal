<%@ Page Title="" Language="C#" MasterPageFile="~/Navigation.Master" AutoEventWireup="true" CodeBehind="CareerGuidance.aspx.cs" Inherits="Brainwave_Website.CareerGuidance" %>
		...
		<section id="page-title" class="page-title-parallax page-title-dark" style="padding: 250px 0; background-image: url('images/Brainwave/gui.jpeg'); background-size: cover; background-position: center center;" data-stellar-background-ratio="0.4">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Career Guidance</li>
				</ol>
			</div>
					...
					<div id="posts" class="post-grid grid-container post-masonry grid-2 clearfix">
						...
						<div class="entry clearfix">
							...
							<div class="entry-content">
								...
								<a href="Area1.aspx"class="more-link">Read More</a>
							</div>
						</div>
					   ...
					   <div class="entry clearfix">
							...
							<div class="entry-content">
								...
								<a href="Area2.aspx"class="more-link">Read More</a>
							</div>
						</div>
						...
						<div class="entry clearfix">
							...
							<div class="entry-content">
								...
								<a href="Area3.aspx"class="more-link">Read More</a>
							</div>
						</div>
                        ...
                        <div class="entry clearfix">
							...
							<div class="entry-image">
								<a href="CXplore.aspx" class="entry-link">
									Find our More about CareerXplora
