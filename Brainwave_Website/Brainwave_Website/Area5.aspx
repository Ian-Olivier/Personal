<%@ Page Title="" Language="C#" MasterPageFile="~/Navigation.Master" AutoEventWireup="true" CodeBehind="Area5.aspx.cs" Inherits="Brainwave_Website.Area5" %>
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					...
					<li class="active">CAREER AREA: 5</li>
				</ol>
			</div>
					...
					<div class="single-post nobottommargin">
						...
						<div class="entry clearfix">
							...
							<div class="entry-title">
								<h1>AGRICULTURE AND ENVIRONMENT</h1>
							</div><!-- .entry-title end -->							
							...
							<div class="entry-content notopmargin">
								...
								<ul style="font-size:18px">
                                    ...
                                    <li>Plants, Landscaping and Gardening</li>
                                    <li>Marine or Water and Sea</li>
                                    <li>Geography and Archaeology</li>
