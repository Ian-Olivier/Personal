<%@ Page Title="" Language="C#" MasterPageFile="~/Navigation.Master" AutoEventWireup="true" CodeBehind="Area8.aspx.cs" Inherits="Brainwave_Website.Area8" %>
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					...
					<li class="active">CAREER AREA: 8</li>
				</ol>
			</div>
					...
					<div class="single-post nobottommargin">
						...
						<div class="entry clearfix">
							...
							<div class="entry-image bottommargin">
								<a href="#"><img src="images/Brainwave/artz.jpeg" alt="Blog Single"></a>
							</div><!-- .entry-image end -->
