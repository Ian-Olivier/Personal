<%@ Page Title="" Language="C#" MasterPageFile="~/Navigation.Master" AutoEventWireup="true" CodeBehind="Area4.aspx.cs" Inherits="Brainwave_Website.Area4" %>
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					...
					<li class="active">CAREER AREA: 4</li>
				</ol>
			</div>
					...
					<div class="single-post nobottommargin">
						...
						<div class="entry clearfix">
							...
							<div class="entry-title">
								<h1>BUSINESS, FINANCE AND MANAGEMENT</h1>
							</div><!-- .entry-title end -->							

							<!-- Entry Image
							============================================= -->
							<div class="entry-image bottommargin">
								<a href="#"><img src="images/Brainwave/bus.jpeg" alt="Blog Single"></a>
							</div><!-- .entry-image end -->
							...
							<div class="entry-content notopmargin">
								...
								<ul>
                                    ...
                                    <li>Administration, Clerical or Call Centres</li>
