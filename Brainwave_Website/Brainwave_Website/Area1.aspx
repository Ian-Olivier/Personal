<%@ Page Title="" Language="C#" MasterPageFile="~/Navigation.Master" AutoEventWireup="true" CodeBehind="Area1.aspx.cs" Inherits="Brainwave_Website.Area1" %>
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					...
					<li class="active">CAREER AREA: 1</li>
				</ol>
			</div>
					...
					<div class="single-post nobottommargin">
						...
						<div class="entry clearfix">
							...
							<div class="entry-content notopmargin">
								...
								<ul style="font-size:18px">
                                    ...
                                    <li>Artisans</li>
                                    <li>Manufacturing</li>
                                    <li>Automotive or Automotive Support</li>
                                    <li>Geology, Mining and Mining Support</li>
                                    <li>Woodwork and Furniture</li>
								</ul>
						...
						<div class="related-posts clearfix">
							...
							<div class="col_half nobottommargin">
								...
								<div class="mpost clearfix">
									<div class="entry-image">
										<a href="Area2.aspx"><img src="images/Brainwave/bio.jpg" alt="Blog Single"></a>
									</div>
									<div class="entry-c">
										<div class="entry-title">
											<h4><a href="Area2.aspx">health and natural sciences</a></h4>
										</div>
